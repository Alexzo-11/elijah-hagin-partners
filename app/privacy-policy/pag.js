        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card-premium p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none text-[#4A4C4E]">
              {/* Full privacy policy content here - same as before */}
              <p className="text-lg">
                At Exousia Fellowship Incorporated, we are committed to protecting your privacy and ensuring the security of your personal information...
              </p>
              ...
              <h2 className="text-2xl font-bold text-[#4A4C4E] mt-8">Third-Party Services</h2>
              <p>We may use third-party services to process payments and send communications. These providers are contractually obligated to protect your data and use it only for the purposes we specify.</p>

              <h2 className="text-2xl font-bold text-[#4A4C4E] mt-8">Your Rights</h2>
